...
export function EditCategoryDialog({isOpen = false, value, onClose, onSubmit, onChangeText}: EditDialogProps) {
    ...
    <Portal>
      <Dialog visible={isOpen} onDismiss={onClose}>
        ...
        <Dialog.Content>
          ...
          <TextInput 
            mode='outlined' 
            style={{marginTop: 11, marginBottom: 18, backgroundColor: theme.colors.surfaceVariant}} 
